...
is identical to the original compToOx.csv file.
"""
...
def test_compToOx_identical():
    ...
    # File paths
    original_file = projections_dir / 'PxSp_Comp_Transform.csv'
    reduced_file = projections_dir / 'PxSp_Comp_Transform_REDUCED.csv'
