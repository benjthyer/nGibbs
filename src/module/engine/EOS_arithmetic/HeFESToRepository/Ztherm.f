	...
	double precision zetad1,zetad2,zetad3,zetae,zetae1,zetae2,zetae3,zetae4,zetao,zetas,heat
        ...
        logical aniso,trace_opened
        save trace_opened
        data trace_opened /.false./
        aniso = .false.
...
C  Optic Continuum
        ...
        if (.not. trace_opened) then
         open(74,file='fort.74',status='unknown',form='formatted')
         trace_opened = .true.
        end if
        write(74,*) 'ZTHERM',Ti,su,do,wd1,ws1,we1,wou,wol,zetad,zetas,zetae,zetao,Ztherm
