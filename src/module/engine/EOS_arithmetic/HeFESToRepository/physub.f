...
C  Dump dndt and dndp for external validation
       write(42,*) 'dndt and dndp by species:'
       do 1581 ispec=1,nspec
        write(42,'(i5,1x,a4,2f16.8)') ispec,sname(ispec),dndt(ispec),dndp(ispec)
1581   continue
