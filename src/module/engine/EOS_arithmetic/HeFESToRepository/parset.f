...
c  Convert these others to units of Kelvin here
		...
		! call ensure_fort31_open()
		!if (ncall .le. 10) then
		write(601,*) 'PARSET',ispec,fn,zu,wm,To,Fo,Vo,Ko,Kop,Kopp
		write(602,*) 'PARSETM',ispec,wd1,wd2,wd3,ws1,ws2,ws3,we1,we2,we3,we4,wou,wol
		write(603,*) 'PARSETP',ispec,gam,qo,be,ge,q2A2,htl,ibv,ied,izp,Go,Gop,Got
		!end if
