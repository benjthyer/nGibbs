...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=None, help="Figure output path (default: <repo>/plots/<csv-stem>_SiMg_heatmap.png).")
...
def main() -> None:
    ...
    out = args.out
    if out is None:
        out = plot_path(f"{args.csv.stem}_SiMg_heatmap.png")
